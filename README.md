📊 ETL Using Python: Top 10 world banks (Wikipedia)
...
This was my first project in ETL, and it helped me understand the complete workflow from extraction to loading.
...
3. transform(df)
    ...
    Converts values (e.g., Dollars -> INR)
...
Example: Replace with any World banks data table URL from Wikipedia.

🟢 Output

During execution, the script prints real-time status updates from each stage.
On successful completion without errors, it prints a completed mesaage using stars line indicating success.
...
🙌 Learning Experience
    ...
    This was my first ETL project, and through it I learned:
